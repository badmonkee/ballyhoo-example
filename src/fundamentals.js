...
function main() {
  ...
  const models = {
    pig: {
      url:
        "./resources/models/Pig.gltf"
    },
    llama: {
      url:
        "./resources/models/Llama.gltf"
    },
    pug: {
      url:
        "./resources/models/Pug.gltf"
    },
    sheep: {
      url:
        "./resources/models/Sheep.gltf"
    },
    zebra: {
      url:
        "./resources/models/Zebra.gltf"
    },
    horse: {
      url:
        "./resources/models/Horse.gltf"
    },
    knight: {
      url:
        "./resources/models/KnightCharacter.gltf"
    }
  };

  {
    ...
    for (const model of Object.values(models)) {
        ...
        console.log("load model "+model.url);
